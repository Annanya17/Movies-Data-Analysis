...
Interactive Movies Data Analysis Dashboard using MS Excel
## 1.Project Title
Movies Data Analysis Using MS Excel
## 2.Project Review
This project focuses on analyzing a Movies dataset to uncover meaningful insights about movie performance, audience preferences, and industry trends.The dataset includes information such as movie titles,content-type, genres, duration, release years, ratings, revenue, runtime, and production budget.
...
Identify content type wise IMDB ratings.

Analyze investment vs return on different content.

Examine the relationship between content type and their durations.

Determine the country-wise investment vs return.
